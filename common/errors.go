...
var (
	...
	ErrBenefactorMissing           = errors.New("benefactor address is missing")
	ErrBeneficiaryMissing          = errors.New("beneficiary address is missing")
	ErrInvalidBenefactor           = errors.New("invalid benefactor address")
