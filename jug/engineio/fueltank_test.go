...
func TestNewFuelTank(t *testing.T) {
	...
	require.Equal(t, Fuel(0), tank.Consumed, "FuelTank was not initialized with 0 consumed fuel")
	require.Equal(t, Fuel(10), tank.Capacity, "FuelTank was not initialized with the correct capacity")
}
...
func TestFuelTank_Level(t *testing.T) {
	...
	tank.Exhaust(5)
	require.Equal(t, tank.Capacity-5, tank.Level(), "Fuel level did not decrease after fuel was exhausted")
}
