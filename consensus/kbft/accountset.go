...
func (as *AccountSet) GetByIndex(index int64) (addrs identifiers.Address) {
	// Check for index out of bounds
	if index < 0 || int(index) >= len(as.set) {
		return identifiers.Address{}
	}
...
func (as *AccountSet) GetByAddress(addr identifiers.Address) int64 {
