...
type WAL interface {
	Write(ktypes.ConsensusMessage, common.ClusterID) error
	WriteSync(ktypes.ConsensusMessage, common.ClusterID) error
	FlushAndSync() error
...
func (wal *BaseWAL) Write(msg ktypes.ConsensusMessage, clusterID common.ClusterID) error {
	if wal == nil {
		return nil
	}
...
// NOTE: calls fsync()
func (wal *BaseWAL) WriteSync(msg ktypes.ConsensusMessage, clusterID common.ClusterID) error {
	if wal == nil {
		return nil
	}
