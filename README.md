...
|  `logiclab`  | Sandbox playground environment for compiling manifest into logics, simulating logic calls and participant interactions with logics on MOI. | [LogicLab CLI Docs](https://cocolang.dev/tour/logiclab-cli)          |
