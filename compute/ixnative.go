...
// CreateAsset performs the IxCreateAsset interaction on the given creator Object.
...
func (executor IxExecutor) CreateAsset(
	creator, assetAccount *state.Object,
	payload common.AssetCreatePayload,
) (
	engineio.Fuel, *common.AssetCreationReceipt, error,
) {
	...
	asset := common.NewAssetDescriptor(creator.Address(), payload)
	...
	return FuelAssetCreation, &common.AssetCreationReceipt{AssetID: assetID, AssetAccount: assetAccount.Address()}, nil
}

func (executor IxExecutor) MintAsset(
	assetOperator, assetAccount *state.Object,
	payload common.AssetMintOrBurnPayload,
) (
	engineio.Fuel, *common.AssetMintOrBurnReceipt, error,
) {
	...
	return FuelSimpleValueTransfer, &common.AssetMintOrBurnReceipt{TotalSupply: (hexutil.Big)(*ad.Supply)}, nil
}
...
func (executor IxExecutor) BurnAsset(
	...
	if bal.Cmp(payload.Amount) < 0 {
		return nil, nil, common.ErrInsufficientFunds
	}
	...
	return FuelSimpleAssetMint, &common.AssetMintOrBurnReceipt{TotalSupply: (hexutil.Big)(*ad.Supply)}, nil
}
...
func (executor IxExecutor) LogicDeploy(
	...
	logicstate, deployer *state.Object,
...
func (executor IxExecutor) LogicInvoke(
	tank *engineio.FuelTank,
	logicstate, sender *state.Object,
	payload *common.LogicPayload,
) (
