...
func (manager *Manager) ValidateLogicInvoke(receiverObject *state.Object, ix *common.Interaction) error {
	logicObject, err := receiverObject.FetchLogicObject(ix.LogicID())
	if err != nil {
		return err
	}
