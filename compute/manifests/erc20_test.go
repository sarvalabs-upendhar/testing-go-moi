...
func (suite *ERC20TestSuite) SetupSuite() {
	...
	consumed, _, errdata := suite.Call("Seeder!", map[string]any{
		...
		"symbol": "MOI",
		"supply": 100000000,
		"seeder": common.HexToAddress(erc20Addr1),
	})
...
func (suite *ERC20TestSuite) TestApproval() {
	...
	consumed, output, except := suite.Call("Approve!", map[string]any{
		"owner":   common.HexToAddress(erc20Addr1),
		"spender": common.HexToAddress(erc20Addr2),
		"amount":  500,
	})
	...
	consumed, output, except = suite.Call("Allowance", map[string]any{
		"owner":   common.HexToAddress(erc20Addr2),
		"spender": common.HexToAddress(erc20Addr3),
	})
...
func (suite *ERC20TestSuite) TestTransfer() {
	...
	consumed, output, except := suite.Call("BalanceOf", map[string]any{"addr": common.HexToAddress(erc20Addr1)})
	...
	consumed, output, except = suite.Call("Transfer!", map[string]any{
		"from":   common.HexToAddress(erc20Addr1),
		"to":     common.HexToAddress(erc20Addr4),
		"amount": 1000,
	})
	suite.Equal(true, output["ok"])
	...
	consumed, output, except = suite.Call("BalanceOf", map[string]any{"addr": common.HexToAddress(erc20Addr4)})
	...
	consumed, output, except = suite.Call("Transfer!", map[string]any{
		"from":   common.HexToAddress(erc20Addr4),
		"to":     common.HexToAddress(erc20Addr5),
		"amount": 10000,
	})
...
func (suite *ERC20TestSuite) TestInflation() {
	...
	consumed, output, except = suite.Call("Burn!", map[string]any{
		"addr":   common.HexToAddress(erc20Addr1),
		"amount": 10000,
	})
	suite.Equal(true, output["ok"])
	...
	consumed, output, except = suite.Call("Mint!", map[string]any{
		"addr":   common.HexToAddress(erc20Addr6),
		"amount": 10000,
	})
	suite.Equal(true, output["ok"])
	...
	consumed, output, except = suite.Call("BalanceOf", map[string]any{"addr": common.HexToAddress(erc20Addr6)})
